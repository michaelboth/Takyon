...
Mac and Linux
  ...
  Testing
    ...
    RDMA RC (Reliable Connected)
      ...
      A> ./throughput_mp A "RdmaRC -client -remoteIP=192.168.50.234 -port=23456 -rdmaDevice=mlx5_0 -rdmaPort=1" -i=1000000 -bytes=40960 -sbufs=50 -dbufs=50 -write
      B> ./throughput_mp B "RdmaRC -server -localIP=192.168.50.234 -port=23456 -reuse -rdmaDevice=mlx5_0 -rdmaPort=1" -i=1000000 -bytes=40960 -sbufs=50 -dbufs=50 -write
