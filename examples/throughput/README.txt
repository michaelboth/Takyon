...
Mac and Linux
  ...
  Testing
    ...
    RDMA UC (unreliable connected; messages may be quietly dropped)
      A> ./throughput_mp A "RdmaUC -client -remoteIP=192.168.50.234 -port=23456 -rdmaDevice=mlx5_0 -rdmaPort=1" -n=10000000 -b=4096 -s=100
      B> ./throughput_mp B "RdmaUC -server -localIP=192.168.50.234 -port=23456 -reuse -rdmaDevice=mlx5_0 -rdmaPort=1" -n=10000000 -b=4096 -r=1000
  Clean:
    > make clean
