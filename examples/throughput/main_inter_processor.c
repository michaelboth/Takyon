...
int main(int argc, char **argv) {
  ...
  throughput(is_endpointA, provider, L_iterations, L_message_bytes, L_src_buffer_count, L_dest_buffer_count, L_use_polling_completion, L_transfer_mode, L_validate);
