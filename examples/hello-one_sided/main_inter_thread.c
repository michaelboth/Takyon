...
static void *helloThread(void *user_data) {
  bool is_endpointA = (user_data != NULL);
  hello(is_endpointA, L_interconnect, L_iterations);
  return NULL;
}
...
int main(int argc, char **argv) {
  ...
  pthread_create(&endpointA_thread_id, NULL, helloThread, (void *)1LL);
  pthread_create(&endpointB_thread_id, NULL, helloThread, NULL);
